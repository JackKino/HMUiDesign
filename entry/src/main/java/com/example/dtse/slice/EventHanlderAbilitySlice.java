...
import com.example.dtse.slice.ViewHolder.PlayListItemViewHolder;
import com.example.dtse.slice.model.PlayListItemModel;
...
public class EventHanlderAbilitySlice extends AbilitySlice {
        ...
        ultimateProvider.setEventTransmissionListener(new EventTransmissionListener() {
            ...
            public Object onEventTransmission(Object target, Object params, int eventId, CallBack callBack) {
                if (target instanceof PlayListItemViewHolder){
                    ...
                    }else  if (eventId == 3) {//播放列表中播放被点击，演示同步返回数据
